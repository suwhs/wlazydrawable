...
public final class LittleEndianDataInputStream extends FilterInputStream
    ...
    public int readUnsignedShort() throws IOException {
        ...
        return Ints_fromBytes((byte) 0, (byte) 0, b2, b1);
    }
    ...
    public int readInt() throws IOException {
        ...
        return Ints_fromBytes(b4, b3, b2, b1);
    }

    public static int Ints_fromBytes(byte b1, byte b2, byte b3, byte b4) {
    ...
    public long readLong() throws IOException {
        ...
        return Longs_fromBytes(b8, b7, b6, b5, b4, b3, b2, b1);
    }

    private long Longs_fromBytes(
